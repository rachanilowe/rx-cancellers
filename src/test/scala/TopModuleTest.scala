...
class TopModuleBlock() extends Module {
    ...
    val dut = Module(new CancellersTopModule())
    dut.io.tx0 := io.tx0
    dut.io.tx1 := io.tx1
    dut.io.tx2 := io.tx2
    dut.io.tx3 := io.tx3
...
class TopModuleTest extends AnyFreeSpec with ChiselScalatestTester {
  ...
  //         dut.io.tx0.poke(tx0.S(3.W))
  //         dut.io.tx1.poke(tx1.S(3.W))
  //         dut.io.tx2.poke(tx2.S(3.W))
  //         dut.io.tx3.poke(tx3.S(3.W))
  //         dut.io.txValid.poke(true.B)
  ...
  //   }
    ...
    .withAnnotations(Seq(WriteVcdAnnotation)) { dut =>
      ...
      for (i <- 0 until steps) {
        ...
        dut.io.tx0.poke(localNoise0.S(3.W))
        dut.io.tx1.poke(localNoise1.S(3.W))
        dut.io.tx2.poke(localNoise2.S(3.W))
        dut.io.tx3.poke(localNoise3.S(3.W))
        dut.io.txValid.poke(true.B)
