...
class CancellersTopModule() extends Module {
    ...
    val echoCanceller = Module(new HybridAdaptiveFIRFilter(30, 3))
    val nextCanceller1 = Module(new HybridAdaptiveFIRFilter(18, 3))
    val nextCanceller2 = Module(new HybridAdaptiveFIRFilter(18, 3))
    val nextCanceller3 = Module(new HybridAdaptiveFIRFilter(18, 3))
    ...
    io.desiredCancelled := io.desired - ((echoCanceller.io.dout + nextCanceller1.io.dout + nextCanceller2.io.dout + nextCanceller3.io.dout) >> 4)
}

object Cancellers extends App {
  ChiselStage.emitSystemVerilogFile(
    new CancellersTopModule,
