...
tx0 = [random.randint(-2, 3) for _ in range(num_points)]
tx1 = [random.randint(-2, 3) for _ in range(num_points)]
tx2 = [random.randint(-2, 3) for _ in range(num_points)]
tx3 = [random.randint(-2, 3) for _ in range(num_points)]
